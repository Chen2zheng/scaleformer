...
from reverse import TransShuffleNet
# from scaleformer.MutiFormer import ScaleFormer
...
parser.add_argument("--output_dir", type=str, default="./model_out/Alba/layers_1344_1221", help="output dir")
...
parser.add_argument("--num_workers", type=int, default=8, help="num_workers")  #8-14
...
if __name__ == "__main__":
    ...
    net = TransShuffleNet(num_classes=args.num_classes,in_chans=1,).cuda(0)
    # net = ScaleFormer(num_classes=args.num_classes,in_chans=1,).cuda(0)
